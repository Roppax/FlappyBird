...
class Flappy:
    ...
    def playButton(self) :
        font = pygame.font.SysFont ( "Comic Sans Bold", 50 )
        playText = font.render ( "Play", -1, (255, 255, 255) )
        playButtonRect = playText.get_rect ( center=(200, 350) )
        mouse_pos = pygame.mouse.get_pos ()

        for event in pygame.event.get () :
            if event.type == pygame.QUIT :
                sys.exit ()
            elif event.type == pygame.MOUSEBUTTONDOWN and playButtonRect.collidepoint ( mouse_pos ) :
                return True

        self.screen.blit ( self.background, (0, 0) )
        self.screen.blit ( playText, playButtonRect )
